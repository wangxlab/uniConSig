...
## ----eval=FALSE------------------------------------------------------------
#  result.cgc<-cal_uniConSig(trList.cgc,preCal=preCal.data)
#  result.my<-cal_uniConSig(trList.my,preCal=preCal.data)
...
## ----eval=FALSE------------------------------------------------------------
#  result.uniConSig.DEG<-cal_uniConSig(trList.DEG,preCal=preCal.data)
