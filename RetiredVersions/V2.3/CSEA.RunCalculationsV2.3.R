...
source("J:/GenomeIndex/Pipeline_CSEA2/CSEA.modulesV2.3.R")
...
CGC=read.table("J:/GenomeIndex/Pipeline_CSEA2/CancerGene/cancer_gene_census.csv",header=TRUE,sep=",")
...
limma=limmaDGE(gctFile="J:/GenomeIndex/Pipeline_CSEA2/scDataset/scData_quiescentVsActive.gct",clsFile="J:/GenomeIndex/Pipeline_CSEA2/scDataset/scData_quiescentVsActive.cls")
