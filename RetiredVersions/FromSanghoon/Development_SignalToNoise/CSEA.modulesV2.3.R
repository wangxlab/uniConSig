...
CSEA2<-function(target.score,compare.list,p.cut=0.05,minsize=5){
    ...
    compare.list=lapply(compare.list,filter,filter=names(tmp.weight),inlist=TRUE)  ## because names(tmp.weight) is just "TGFB1", the elements of the list has just "TGFB1"  Then, I should set minsize 0
